...
export async function GET(request: NextRequest) {
  ...
  console.log("[OAuth Callback] Received code:", code ? `${code.slice(0, 5)}...` : "none");
  console.log("[OAuth Callback] Client ID configured:", !!clientId, "Client Secret configured:", !!clientSecret);
  ...
  try {
    ...
    console.log("[OAuth Callback] Exchanging code for token with GitHub...");
    ...
    console.log("[OAuth Callback] GitHub Token Exchange Response:", JSON.stringify(tokenData));
